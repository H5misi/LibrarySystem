...
namespace LibrarySystem
{
    ...
    public partial class BookDashboard : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                cmd = new SqlCommand("insert into BooksInfo(bookId, bookName, authorName, publication, purchaseDate, Availability) values('" + int.Parse(textBox1.Text) + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + dateTimePicker1.Text + "','" + comboBox1.Text.ToString() + "')", con);
                cmd.ExecuteNonQuery();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            comboBox1.SelectedItem = dataGridView1.SelectedRows[0].Cells[5].Value + string.Empty;
        }
    }
}
